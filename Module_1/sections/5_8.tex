...
\begin{example}
    ...
    \begin{itemize}
        ...
        \item $c_{n-1} \dots c_0 \rightarrow$ carry digits. When we add two binary numbers equal to $1$, we carry on the additional digit to the next column
